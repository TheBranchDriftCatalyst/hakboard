...
// It provides an interface (flippable cards) for editing the props of each widget. (currently levo)
...
export const WidgetWidthProvider = ({ width, height, children }) => {
  return (
...
const WidgetWrapper = <T extends object>(
  ...
  const WithEditButton = forwardRef<HTMLDivElement, T & WidgetGridProps>(
    (props, ref) => {
      ...
      // TODO: this is going to move to custom provicer, for now its using leva
